...
import (
	...
	"github.com/nkovacs/counterfeiter/fixtures/fixturesfakes"
...
var _ = Describe("A Fake generated by counterfeiter", func() {
	...
	It("panics when no return value or stub is provided", func() {
		fake.DoNothing()
		Expect(func() {
